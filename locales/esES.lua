...
L.ensureRepairDesc = "Si eres el Maestro de la hermandad, If you are the Guild Master, cada vez que entres a un grupo de raid y seas el líder o ayudante, con esto te asegurarás que las reparaciones de hermandad están activadas para la duración de la raid (hasta 300g). Una vez dejes el grupo, los ajustes serán restaurados a su estado original |cffff4411siempre que no te caigas durante la raid.|r"
