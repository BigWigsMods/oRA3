...
L["showBuffsDesc"] = "Mostrar ícones para buffs de comida, frascos e runas para cada jogador e mostra uma mensagem abaixo do quadro de verificação para os buffs de raid ausentes./n|cffffff33Show missing buffs|r will only show icons if the player is missing buffs./n|cffffff33Show current buffs|r will only show icons for buffs a player has.
